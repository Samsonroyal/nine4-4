    ...
    (<div className="relative">
      <div className="fixed top-0 left-0 right-0 z-10 bg-white/70 backdrop-blur-md">
        <div className="container mx-auto flex items-center justify-between px-4 py-2">
          <div>
            <img alt="Intelli Concierge" className="h-8" src="/placeholder.svg" />
          </div>
      ...
      <main className="pt-16">
        <section className="container mx-auto mt-8 px-4">
          ...
          <div className="mt-6 flex justify-center space-x-4">
            ...
            <a
              className="px-6 py-3 text-sm font-medium text-blue-600 border border-blue-600 rounded-md shadow-sm hover:bg-blue-50"
              href="#">
